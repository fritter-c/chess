...
bool analyzer_is_queen_attacking(const Board *board, SquareIndex index, Color attacker);

bool analyzer_is_pawn_attacking(const Board *board, SquareIndex index, Color attacker);

bool analyzer_is_knight_attacking(const Board *board, SquareIndex index, Color attacker);

bool analyzer_is_king_attacking(const Board *board, SquareIndex index, Color attacker);

bool analyzer_is_rook_attacking(const Board *board, SquareIndex index, Color attacker);

bool analyzer_is_bishop_attacking(const Board *board, SquareIndex index, Color attacker);

bool analyzer_is_queen_attacking(const Board *board, SquareIndex index, Color attacker, SquareIndex origin);

bool analyzer_is_pawn_attacking(const Board *board, SquareIndex index, Color attacker, SquareIndex origin);

bool analyzer_is_knight_attacking(const Board *board, SquareIndex index, Color attacker, SquareIndex origin);

bool analyzer_is_king_attacking(const Board *board, SquareIndex index, Color attacker, SquareIndex origin);

bool analyzer_is_rook_attacking(const Board *board, SquareIndex index, Color attacker, SquareIndex origin);

bool analyzer_is_bishop_attacking(const Board *board, SquareIndex index, Color attacker, SquareIndex origin);
